...
router.get('/', verifyToken, async (req, res) => {
  try {
    ...
    const [contacts, total] = await Promise.all([
      prisma.contact.findMany({ orderBy: { name: 'asc' }, skip, take: limit }),
...
// Bulk delete contacts - MUST be before /:id routes
...
// Import contacts from CSV/XLS file - MUST be before /:id routes
